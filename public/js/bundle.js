...
},{"./components/App.jsx":158,"react":156}],158:[function(require,module,exports){
var React = require("react");
...
var App = React.createClass({displayName: "App",
    ...
    render : function(){
        ...
        {
            return (
                React.createElement(GithubUserForm, {
...
},{"./githubForm.jsx":159,"./showFollowers.jsx":160,"./showProfile.jsx":161,"./showRepository.jsx":162,"react":156}],159:[function(require,module,exports){
var React = require("react");

var GithubUserForm = React.createClass({displayName: "GithubUserForm",
    getInitialState : function(){
        return ({
            text : ''
        });
   ...
   render: function(){
       var value =this.state.text;
          return (
                React.createElement("div", {id: "form_hookuser", className: "jumbotron"}, 
                    React.createElement("form", {onSubmit: this.handleSubmit}, 
                        React.createElement("div", {className: "input-group input-group-lg"}, 
                            React.createElement("span", {className: "input-group-btn"}, 
                                React.createElement("button", {className: "btn btn-default", type: "submit"}, "OK!")
                            ), 
...
var FollowerList  = React.createClass({displayName: "FollowerList",
    render : function(){
        return (React.createElement("li", {className: "media list-followers", onClick: this.props.onClick}, 
                    React.createElement("div", {className: "media-left  media-middle"}, 
                        React.createElement("img", {className: "media-object img-circle img_avatar_follower", alt: "140x140", src: this.props.items.avatar_url, "data-holder-rendered": "true"})
                    ), 
                    React.createElement("div", {className: "media-body"}, 
                        React.createElement("h4", null, this.props.items.login)
                    )
                ));
    }
});

var ShowFollowers = React.createClass({displayName: "ShowFollowers",
        ...
        return (
                React.createElement("div", {className: "caption"}, 
                    ...
                    this.props.followersData.map(function(result,idx){
                        return (React.createElement(FollowerList, {
                            key: idx, 
                            items: result, 
...
var ShowProfileImg = React.createClass({displayName: "ShowProfileImg",
    render : function(){
        return (
            React.createElement("div", {className: "col-sm-3"}, 
                React.createElement("img", {className: "img_avatar", alt: "140x140", src: this.props.avatar_url, "data-holder-rendered": "true"})
            )
        );
    }
});
...
var ShowProfileInfo = React.createClass({displayName: "ShowProfileInfo",
    render : function(){
        return (
            React.createElement("div", {className: "row user-profile"}, 
                React.createElement(ShowProfileImg, {avatar_url: this.props.avatar_url}), 
                React.createElement("div", {className: "col-sm-9"}, 
                    React.createElement("div", {className: "caption"}, 
                        React.createElement("div", {className: "media-body"}, 
                            React.createElement("h1", null, this.props.login), 
...
var PaginationPages = React.createClass({displayName: "PaginationPages",
    render : function(){
        return (
                React.createElement("li", {className: "Active"}, 
                  React.createElement("span", null, "1 ", React.createElement("span", {className: "sr-only"}, "(current)"))
                )
            );
    }
});
        ...
        return (
            React.createElement("nav", null, 
              React.createElement("ul", {className: "pagination"}, 
                ...
                React.createElement(PaginationPages, null), ");"
              )
            )
        );
    }
...
var ReposList = React.createClass({displayName: "ReposList",
     render : function(){
            return (React.createElement("li", {className: "reposList"}, this.props.items.name));
    }
});

var ShowRepos = React.createClass({displayName: "ShowRepos",
    render : function(){
        return (
            React.createElement("div", {className: "caption"}, 
                React.createElement("h2", null, "Repository"), 
                React.createElement("ul", {className: "showRepos"}, 
                this.props.reposData.map(function(result,idx){
                    return (React.createElement(ReposList, {
                        key: idx, 
                        items: result}));
                })
                )
